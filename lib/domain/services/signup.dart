...
Future<LoginResultModel> register(LoginModel login) async {
  //Api path
  //for ios:127.0.0.1
  const mainAPI = 'http://10.0.2.2:5000';
  const loginAPI = '/api/register';
  ...
  if (response.statusCode == 200) {
    ...
    return LoginResultModel(response.statusCode, "You already have an account");
  }
}
